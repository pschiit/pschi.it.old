...
describe('initialize Vector4', () => {
    ...
    test('clone Vector4', () => {
        const result = new Vector4([2, 4, 6, 8]);
...
describe('Vector4 operations', () => {
    describe('equals a Vector4', () => {
        test('should return true if values are the same', () => {
            expect(new Vector4(2, 4, 6, 8).equals(new Vector4(2, 4, 6, 8))).toBeTruthy();
        });

        test('should return false if values are different', () => {
            expect(new Vector4(2, 4, 6, 8).equals(new Vector4(8, 6, 4, 2))).toBeFalsy();
        });
    });
